        ...
        <form onSubmit={handlePayment} className="space-y-10 sm:space-y-12">
            ...
            <section>
                ...
                <div className="space-y-4 pl-0 sm:pl-11">
                    <div>
                        ...
                        <input name="email" value={formData.email} onChange={handleInputChange} type="email" className={inputClasses} placeholder="you@example.com" required />
                    </div>
                    <div>
                        <label className={labelClasses}>Phone Number</label>
                        <input name="phone" value={formData.phone} onChange={handleInputChange} type="tel" className={inputClasses} placeholder="+60 12-345 6789" />
                    </div>
                </div>
            </section>
            ...
            <section>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pl-0 sm:pl-11">
                    <div className="sm:col-span-2">
                        ...
                        <input name="fullName" value={formData.fullName} onChange={handleInputChange} type="text" className={inputClasses} placeholder="e.g. Sarah Tan" required />
                    </div>
                    <div className="sm:col-span-2">
                        <label className={labelClasses}>Address Line 1</label>
                        <input name="address1" value={formData.address1} onChange={handleInputChange} type="text" className={inputClasses} placeholder="Street address, P.O. box" required />
                    </div>
                    <div className="sm:col-span-2">
                        <label className={labelClasses}>Address Line 2 (Optional)</label>
                        <input name="address2" value={formData.address2} onChange={handleInputChange} type="text" className={inputClasses} placeholder="Apartment, suite, unit, etc." />
                    </div>
                    <div>
                        <label className={labelClasses}>City</label>
                        <input name="city" value={formData.city} onChange={handleInputChange} type="text" className={inputClasses} placeholder="City" required />
                    </div>
                    <div>
                        <label className={labelClasses}>Postcode</label>
                        <input name="postcode" value={formData.postcode} onChange={handleInputChange} type="text" className={inputClasses} placeholder="Postcode" required />
                    </div>
                    <div className="sm:col-span-2">
                        <label className={labelClasses}>State</label>
                        <div className="relative">
                            <select name="state" value={formData.state} onChange={handleInputChange} className={`${inputClasses} appearance-none pr-10 text-sage-900`}>
            ...
            <section>
                ...
                <div className="pl-0 sm:pl-11">
                    {/* ... (Shipping Method Labels remain same as your code) */}
